    ...
    <?php error_reporting(0);?>
                ...
                <tr>
                    <td>
                        <h4>Modo de juego: <select name="slcParty">
                            <option value="Clasico 5 vs. 5">Clasico 5 vs. 5</option>
        ...
        <?php
                    ...
                    if ($_POST['btnSave'] == "Registrar"){
                        ...
                        $sql = "insert into party(`id_party`, `host`, `name`, `game_mode`, `fecha`, `descripcion`, `game`) VALUES ('','$HOST','$NAME','$MODE','$DATE','$DESC','1')";
                        
                        mysqli_query($cnn,$sql);
                        echo "<script>alert('Felicidades, te has registrado exitosamente)</script>";
                        echo "<script type='text/javascript'>window.location='crear_partida_2_lol.php'</script>";
                    }
                ?>
    </body>
</html>