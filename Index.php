<html>
    ...
    <body background="Fondo_index3.jpg" >
        ...
        <header>
		<div class="wrapper">
			<div class="logo">AIEP GAMING</div>
			
			<nav>
				<a href="login.php">Iniciar sesion</a>
				<a href="Agregar_usuario-1.php">Registrarse</a>
			</nav>
		</div>
	</header>
            ...
            <center>
            <div class="imagenes">
                <a href="https://www.eneba.com/latam/"><colspan="4"><img src="eneba.png" height="550" width="342" align="left"  border="0" ></a>
                <a href="cs_go.php"><colspan="4"><img src="counter.png" height="550" width="342" align="center"  border="0" ></a>
                <a href="lol.php"><colspan="4"><img src="lol.png" height="550" width="342" align="center"  border="0" ></a>
                <a href="valor.php"><colspan="4"><img src="valorant.png" height="550" width="342" align="center" border="0" ></a>
                <a href="https://www.g2a.com/es/"><colspan="4"><img src="g2a_logo.svg" height="550" width="342" align="right" border="0" ></a>
            </div>
            </center>
            <nav>
                <ul >
                    <h3 >Paginas que pueden interesarte</h3>
                    <li><img src="solotodo_logo.svg" width="160" height="50"></li>
